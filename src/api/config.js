...
export const API_URLS = {
  ...
  todo: {
    ...
    multidelete: `${BASE_URL}/todo/deleteMany/`,
    list: `${BASE_URL}/todo/list`,
    count: `${BASE_URL}/todo/count`,
    aggregate: `${BASE_URL}/todo/aggregate`,
    softdelete: `${BASE_URL}/todo/softDelete/`,
    multisoftdelete: `${BASE_URL}/todo/softDeleteMany/`,
    singlerecord: `${BASE_URL}/todo/`
  },
  user: {
